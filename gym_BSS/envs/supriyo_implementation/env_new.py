...
class BSSEnv(gym.Env):
    ...
    def __init__(self, nzones=95, ntimesteps=100, data_dir=None, data_set_name='actual_data_art', scenarios=list(range(1, 6))):
        super().__init__()
        self.scenarios=list(range(1, 6))
        self.nzones = nzones
    ...
    def step(self, action):
        ...
        #print("lost_call",lost_demand,"overflow",full_lost_demand)
        self.__t += 1
